...
> 本文是另一篇[《Android Native Hook工具实践》](/2018/07/06/Android-Native-Hook-Practice/)的一份补充文章。本文将会对该文中关于ARM32下的PC指令修复的技术细节进行阐述。本文的大部分源码来自于ele7enxxh大神的项目，由于大神的技术博客里解释省略了较多细节，所以出于学习的目的，本人来一点一点慢慢啃。

## 前言

目前需要进行PC修复的ARM32指令主要有如下几类：
